(() => {
    ...
    const forms_form = document.querySelector(".form");
    const submitButton = forms_form.querySelector('button[type="submit"]');
    function checkForm() {
        const requiredFields = forms_form.querySelectorAll("[data-required]");
        let valid = true;
        requiredFields.forEach((field => {
            if (!field.value.trim()) valid = false;
        }));
        if (valid) submitButton.disabled = false; else submitButton.disabled = true;
    }
    forms_form.addEventListener("input", checkForm);
    document.addEventListener("selectCallback", checkForm);
    function formSubmit() {
    ...
    document.addEventListener("selectCallback", (function(e) {
        ...
        const selectBlock = currentSelect.closest(".select");
        ...
        if (selectValue === "Other") {
            ...
            input.addEventListener("focus", (() => {
                selectBlock.classList.remove("_select-open");
            }));
        } else valueContainer.innerHTML = `\n\t\t\t<span class="select__content">\n\t\t\t\t${selectValue}\n\t\t\t</span>\n\t\t`;
    }));
